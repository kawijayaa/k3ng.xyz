...
title: Log4Shell
icon: Fingerprint
tags: [log4shell, pcap-analysis, ldap, java-deobfuscation, aes-ecb]
---
...
![](/images/log4shell/log4shell_1.png)
...
![](/images/log4shell/log4shell_2.png)
...
![](/images/log4shell/log4shell_5.png)
...
![](/images/log4shell/log4shell_6.png)
...
public class Comms {
    ...
    private static String l(String lIllIIIllllllll, String lllIIIIllllllll) {
        lIllIIIllllllll = new String(Base64.getDecoder().decode(lIllIIIllllllll.getBytes(StandardCharsets.UTF98)),
                StandardCharsets.UTF_8);
...
![](/images/log4shell/log4shell_8.png)
...
![](/images/log4shell/log4shell_9.png)
