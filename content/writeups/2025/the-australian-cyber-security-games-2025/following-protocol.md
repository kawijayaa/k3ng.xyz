...
icon: Globe
tags: [ssrf, redis, nginx, path-traversal, aes-cbc]
---
...
```php title='php-backend/index.php'
<?php
...
```docker title='python-backend/Dockerfile'
...
```python title='python-backend/app.py'
...
![](/images/following_protocol/following_protocol_1.png)

![](/images/following_protocol/following_protocol_2.png)
...
```javascript title='node-app/app.js'
app.any('/api/*', (res, req) => {
    let isAborted = false;
    res.onAborted(() => {
        isAborted = true;
...
![](/images/following_protocol/following_protocol_3.png)
...
![](/images/following_protocol/following_protocol_4.png)
...
#### Following the Redis protocol (omg title of the challenge 😲)
...
![](/images/following_protocol/following_protocol_5.png)
