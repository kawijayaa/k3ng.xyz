...
title: eavesdropped
icon: Fingerprint
tags: [trevorc2, git-object-recovery, python-bytecode, aes-cbc, zip-cracking]
---
...
![](/images/eavesdropped/eavesdropped_1.png)

![](/images/eavesdropped/eavesdropped_2.png)

Since Git uses Zlib as their compression algorithm, we can use `binwalk` to extract all Git objects.

![](/images/eavesdropped/eavesdropped_3.png)
...
![](/images/eavesdropped/eavesdropped_4.png)
...
![](/images/eavesdropped/eavesdropped_5.png)

![](/images/eavesdropped/eavesdropped_6.png)

We parsed the nonces and decrypt using the previously analyzed decryption flow to get the commands used.

![](/images/eavesdropped/eavesdropped_7.png)
...
![](/images/eavesdropped/eavesdropped_8.png)

After opening the zip file, the flag will be stored as a QR code.

![](/images/eavesdropped/eavesdropped_9.png)
