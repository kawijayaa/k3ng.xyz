...
title: Sleeper
icon: Fingerprint
tags: [powershell, dnspy, pcap-analysis, aes-cbc, screen-capture]
---
...
![Query parameter from Wireshark](/images/sleeper/sleeper_1.png)
...
![Files on C:\Windows\SysWOW64](/images/sleeper/sleeper_2.png)
...
![Screenshot containing the flag](/images/sleeper/sleeper_3.png)
