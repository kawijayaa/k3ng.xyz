  ...
  const experiences = [
    {
      ...
      description:
        "Developed forensics challenges for DownUnderCTF since 2025.",
      date: "",
    },
    {
      title: "CrikeyCon 11 CTF Crew",
      description:
        "Organised and developed 2 forensics challenges for the on-site CTF.",
      date: "Mar 2026",
    },
    {
      title: "BSides Brisbane CTF Challenge Author",
      description:
        "Developed 2 forensics challenges for the on-site CTF competition.",
      date: "Jul 2025",
    },
    {
    ...
    },
    {
      ...
      description:
        "Managed and organised one of the largest CTF competitions in Indonesia. Also curated and developed forensics challenges for the competition.",
      date: "2024",
    },
    {
      title: "Scientific Committee of CTF COMPFEST 15",
      description:
        "Developed challenges for the competition's qualification round.",
      date: "2023",
    },
  ];
  const achievements = [
    ...
    },
    {
      ...
      description:
        'Achieved 2nd place with the team "UQ "The Squad" CyberSquad".',
      date: "Jul 2025",
    },
    {
      title: "CrikeyCon X CTF 3rd Place",
      description:
        'Achieved 3rd place with the team name "AWAVAUATUSH" consisting of UQ Cyber Squad members.',
      date: "Mar 2025",
    },
    {
      title: "BackdoorCTF Winner",
      description:
        'Achieved 1st place on the capture-the-flag competition with "ADA INDONESIA COY", a merger of the top CTF players of Indonesia.',
      date: "Dec 2024",
    },
    {
      title: "PwC Indonesia Hack A Day 2024 2nd Place",
      description:
        'Achieved 1st Runner Up in Indonesia and fourth globally with the team name "Sudah Adakah Yang Gantikank3ng".',
      date: "Nov 2024",
    },
    {
      title: "Cyber Jawara 2024 International 2nd Place",
      description:
        'Achieved 2nd place with "swusjask fans club", a merger between 4 top university teams of Indonesia (Universitas Indonesia, Institut Teknologi Sepuluh Nopember, Institut Pertanian Bogor, Universitas Gunadarma).',
      date: "Oct 2024",
    },
    {
    ...
    },
    {
      ...
      description:
        'Reached Top 20, going by the name "HengkerNgangNgong" and participated in the Finals with the Attack-Defense format at UNNES Semarang.',
      date: "Aug 2024",
    },
    {
    ...
    },
    {
      ...
      description:
        'Top 15 out of 117 teams going by the team name "HengkerNgangNgong".',
      date: "Sep 2022",
    },
  ];
    ...
    <main className="container mx-auto max-w-4xl px-6 py-24">
      ...
      <section className="mb-12 prose mx-auto">
        <p>
          ...
          currently playing for UQ Cyber Squad. I have participated in CTFs
          since 2022 and mainly play the Forensics category. I also do create
          challenges from time to time.
        </p>
        <p>
          This site hosts writeups from previous competitions and also blog
          posts about things that interests me in cyber-security (probably
          around topics such as forensics, threat hunting, etc.)
        </p>
      </section>
      <section className="mb-12">
        ...
        <ul className="space-y-6">
          {experiences.map(({ title, description, date }) => (
            <li key={title} className="border-l-4 pl-4 border-fd-accent">
